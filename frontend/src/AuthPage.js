...
export default function AuthPage({ onLogin }) {
  ...
  const [showSecurityResetPassword, setShowSecurityResetPassword] = useState(false);
              ...
              <form onSubmit={handleSecurityReset}>
                ...
                <div style={s.field}>
                  ...
                  <div style={s.passwordWrap}>
                    <input
                      style={{ ...s.input, ...s.passwordInput }}
                      type={showSecurityResetPassword ? "text" : "password"}
                      placeholder="********"
                      value={securityReset.new_password}
                      onChange={e => setSecurityReset({ ...securityReset, new_password: e.target.value })}
                      required
                    />
                    {securityReset.new_password && (
                      <button type="button" style={s.toggleBtn} onClick={() => setShowSecurityResetPassword((v) => !v)}>
                        {showSecurityResetPassword ? "Hide" : "Show"}
                      </button>
                    )}
                  </div>
                </div>
